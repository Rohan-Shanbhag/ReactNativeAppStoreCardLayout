...
import { StyleSheet, Text, View, ScrollView, Image, TouchableWithoutFeedback, Animated, Dimensions, SafeAreaView, Linking } from 'react-native';
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 50 }, animatedContentStyle]}>
            <Text style={{ fontSize: 24, paddingBottom: 10 }}>Image</Text>
            <Text>Mimical demonstration of card animation found on the App Store for the app of the day.</Text>
          </Animated.View>
        </View>
      </SafeAreaView>
    );
